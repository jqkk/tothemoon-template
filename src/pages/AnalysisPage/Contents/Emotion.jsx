    ...
    <Container>
      ...
      <CommentContainer>
        ...
        <Navbar>
          ...
          <Nav backgroundColor="rgb(75, 192, 192)">슬픔</Nav>
          <Nav backgroundColor="rgb(255, 205, 86)">분노</Nav>
          <Nav backgroundColor="rgb(255, 159, 64)">놀람</Nav>
          <Nav backgroundColor="rgb(255, 99, 132)">행복</Nav>
        </Navbar>
